        ...
        with self.sessions_lock:
            if packet[TCP].flags == 'S':
                ...
                if session and session['state'] != 'CLOSING':
                    ...
                    new_session = self.create_session(dst_ip, src_ip, packet[TCP].sport, packet[TCP].dport,
                                                      'SYN-RECEIVED', 'IN',
            ...
            with self.sessions_lock:
                ...
                if bgp_session['status'] == 'On':
                    ...
                    if session is None:
                        ...
                        new_session = self.create_session(i['ip'], bgp_session['neighbour_id'], src_port, 179,
                                                          'SYN-SENT', 'OUT', seq_num)
